...
(() => {
  ...
  const SERVICES = [
    ...
    { id: 'selene', name: 'Selene Wallet', category: 'wallets', region: 'Global',
      description: 'Lightweight desktop wallet for Bitcoin Cash.', url: 'https://electron-cash.selenewallet.org',
    ...
    { id: 'membercash', name: 'member.cash', category: 'social', region: 'Global',
      description: 'BCH-tipped micro-blogging / social platform.', url: 'https://member.cash',
      notes: '' },
    ...
    // --- Merchant Services ---
    { id: 'paybutton', name: 'PayButton', category: 'merchant', region: 'Global',
      description: 'Drop-in BCH payment button for websites.', url: 'https://paybutton.org',
      notes: '' },
    { id: 'bchpay', name: 'BCH Pay', category: 'merchant', region: 'Global',
      description: 'Point-of-sale style BCH payment processing.', url: 'https://bch.pay',
